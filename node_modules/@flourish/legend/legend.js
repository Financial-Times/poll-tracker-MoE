(function (global, factory) {
  ...
  (global = global || self, factory(global.legend = {}));
  ...
  function getDomain(domain_, state) {
  	var domain = domain_.sort(ascending$1);
  ...
  DiscreteColorLegend.prototype.on = function(type, callback) {
  	...
  	if (!callback) this._container.on(type, null);
  		...
  		this._container.on(type, function() {
  			var t = event.target, t_parent = t.parentNode;
  ...
  var font_size, font_color, font_family, font_weight, default_text_size = 1;
  ...
  function ContinuousColorLegend(state_) {
  	...
  	this._formatFunction = undefined;
  	this._legend_domain = [];
  	this._id = "fl-legend-continuous-color-" + legend_count$1;
  	this._visible = true;
  ...
  ContinuousColorLegend.prototype._updateLegend = function() {
  	...
  	if (this._marker_value !== null) {
  		var xScale = linear$1().domain([domain.min, domain.max]).range([0, w]);
  ...
  ContinuousColorLegend.prototype._updateLegendLabels = function () {
  	...
  	if (labels.length) {
  		...
  		var prepLabel = (function () {
  			...
  			var scale = linear$1().domain([domain.min, domain.max]).range([0, band_width]);
  ...
  function ContinuousSizeLegend(state_) {
  	...
  	this._formatFunction = undefined;
  	this._id = "fl-legend-continuous-size-" + legend_count$2;
  	this._visible = true;
  	this._auto_title = "";
  ...
  exports.createContinuousColorLegend = createContinuousColorLegend;
  exports.createContinuousSizeLegend = createContinuousSizeLegend;
  exports.createDiscreteColorLegend = createDiscreteColorLegend;
  exports.createLegendContainer = createLegendContainer;
